...
router.get("/ventas/jj/:id", _ventas.getImagenEquipoRevisionByVenta);
router.put("/ventas/k/:id", storage.array('image', 10), _ventas.createImageEquipoPegado);
router.put("/ventas/kk/:id", storage.array('image', 10), _ventas.createImageEquipoRevisado);
...
router.put("/ventas/p/:id", _ventas.editFechaEntregaVinil);
...
router.get("/ventas/hist1/:serie", _ventas.getHistPorSerie);
router.get("/ventas/hist2/:codtag", _ventas.getHistPorCodTag);
var _default = router;
