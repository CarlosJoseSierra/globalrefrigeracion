...
router.put("/ventas/pp/:id", _ventas.addNumEnsambleVinil);
router.put("/ventas/qq/:id", _ventas.addNumEnsambleEquipo);
router.put("/ventas/rr/:id", _ventas.addNumEnsambleVinilEquipo);
