...
exports.getRquerimientosPadre = exports.getRequerimientosActivosXtecnico = exports.getRequerimientosActivos = exports.getReparacionesActivosXtecnico = exports.getAllRequerimientos = exports.editRequerimientosVisitaTecnica = exports.editRequerimientosReparacion = exports.editRequerimientosCierraCaso = exports.editRequerimientosAprobacion = exports.editRequerimientos = exports.createRequerimientos2 = exports.createRequerimientos = void 0;
...
var createRequerimientos2 = /*#__PURE__*/function () {
  ...
  return function createRequerimientos2(_x5, _x6) {
...
var createRequerimientos = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _image, _image2, _image3, _image4, _image5, _imageruta, _imageruta2, _imageruta3, _imageruta4, _imageruta5, pool, codigo, idR, secuencial, totalDetalle, ivaDetalle, totalFinalDetalle, i, pool2, result, idReq, _i, pool3, _result;
      ...
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 6:
          ...
          if (req.files[0] != undefined) {
            _image = req.files[0].filename;
            _imageruta = req.files[0].path;
          } else {
            _image = '';
            _imageruta = '';
          }
          if (req.files[1] != undefined) {
            _image2 = req.files[1].filename;
            _imageruta2 = req.files[1].path;
          } else {
            _image2 = '';
            _imageruta2 = '';
          }
          if (req.files[2] != undefined) {
            _image3 = req.files[2].filename;
            _imageruta3 = req.files[2].path;
          } else {
            _image3 = '';
            _imageruta3 = '';
          }
          if (req.files[3] != undefined) {
            _image4 = req.files[3].filename;
            _imageruta4 = req.files[3].path;
          } else {
            _image4 = '';
            _imageruta4 = '';
          }
          if (req.files[4] != undefined) {
            _image5 = req.files[4].filename;
            _imageruta5 = req.files[4].path;
          } else {
            _image5 = '';
            _imageruta5 = '';
          }
  ...
  return function createRequerimientos(_x7, _x8) {
...
var editRequerimientos = /*#__PURE__*/function () {
  ...
  return function editRequerimientos(_x9, _x10) {
...
var editRequerimientosVisitaTecnica = /*#__PURE__*/function () {
  ...
  return function editRequerimientosVisitaTecnica(_x11, _x12) {
...
var editRequerimientosAprobacion = /*#__PURE__*/function () {
  ...
  return function editRequerimientosAprobacion(_x13, _x14) {
...
var getRequerimientosActivosXtecnico = /*#__PURE__*/function () {
  ...
  return function getRequerimientosActivosXtecnico(_x15, _x16) {
...
var getReparacionesActivosXtecnico = /*#__PURE__*/function () {
  ...
  return function getReparacionesActivosXtecnico(_x17, _x18) {
...
var getRquerimientosPadre = /*#__PURE__*/function () {
  ...
  return function getRquerimientosPadre(_x21, _x22) {
...
var editRequerimientosCierraCaso = /*#__PURE__*/function () {
  ...
  return function editRequerimientosCierraCaso(_x23, _x24) {
