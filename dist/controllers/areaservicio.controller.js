...
exports.updateActivoByTecnico = exports.getReporteGeneral = exports.getAreaSinTecnico = exports.getAreaServicioMovimiento = exports.getAreaServicioMantenimiento = exports.getAreaByTecnico = exports.getAreaBySerie = exports.getAreaByPlaca = exports.createNewAreaServicioByRequerimiento = exports.createNewAreaServicio = void 0;
...
var createNewAreaServicioByRequerimiento = /*#__PURE__*/function () {
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    var pool, codigo, idC, secuencial, pool2, result;
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        ...
        case 13:
          ...
          _context10.next = 16;
          return pool2.request().input("AS_secuencial", _database.sql.VarChar, secuencial).input("AS_SS_id", _database.sql.Decimal, req.body.Servicio).input("AS_USU_id", _database.sql.Decimal, req.body.TecnicoChofer).input("AS_CLI_id", _database.sql.Decimal, req.body.Cliente).input("AS_TPS_id", _database.sql.Decimal, req.body.TipoServicio).input("AS_UBIC_id", _database.sql.Decimal, req.body.Ciudad).input("AS_serie", _database.sql.VarChar, req.body.Serie).input("AS_placa", _database.sql.VarChar, req.body.Placa).input("AS_EQUIP_id", _database.sql.Decimal, req.body.Modelo).input("AS_observacionTecnica", _database.sql.VarChar, req.body.ObservacionTecnica).input("AS_USU_ing", _database.sql.Decimal, req.body.id).input("AS_Subtotal", _database.sql.Decimal(18, 2), req.body.Subtotal).input("AS_iva", _database.sql.Decimal(18, 2), req.body.IVA).input("AS_total", _database.sql.Decimal, req.body.Total).input("AS_Reporte", _database.sql.VarChar, req.body.CodigoReq).input("AS_IE_id", _database.sql.Decimal, req.body.idReq).input("AS_fechaReq", _database.sql.DateTime, req.body.FechaReq).query(_database.querys.addNewAreaServicioByReq);
        case 16:
